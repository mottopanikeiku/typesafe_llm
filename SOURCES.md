...
sources below are official TypeSafe documentation, API schemas, and SDK code.
...
separate requests with isolated states. This decoder therefore conditions each
emission on the actual selected prefix in a new request.
